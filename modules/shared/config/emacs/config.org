...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Martin Hardselius"
    user-mail-address "martin@hardselius.dev")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mch/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mch/bin" "/profile/bin" "/Users/mch/.npm-packages/bin" "/Users/mch/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
